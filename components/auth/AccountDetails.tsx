...
export default function AccountDetails() {
  ...
  //  if there is no data then we should return
    ...
    return (
      <div className='w-[90%] sm:w-[70%] md:w-[50%] grid grid-cols-2 p-2 h-fit shadow-xl rounded-lg bg-white '>
        <div className='col-span-2 h-[70px] p-4 flex justify-start'>
            <h1 className='text-xl font-bold text-start'>tell us more about your self </h1>
        </div>
        <div className='flex flex-col px-4 col-span-2 sm:col-span-1 gap-x-2'>
        ...
        <div className='flex flex-col px-4 gap-x-2 col-span-2 sm:col-span-1 my-4 sm:my-0'>
